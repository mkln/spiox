...
inocs <- function(Y, X, coords, radgp_rho, theta_opts, spf_k, spf_a_delta, spf_b_delta, spf_a_dl, spf_Lambda_start, spf_Delta_start, mvreg_B_start, mcmc = 1000L, print_every = 100L, sample_precision = 1L, sample_mvr = TRUE, sample_gp = TRUE) {
    .Call(`_inocs_inocs`, Y, X, coords, radgp_rho, theta_opts, spf_k, spf_a_delta, spf_b_delta, spf_a_dl, spf_Lambda_start, spf_Delta_start, mvreg_B_start, mcmc, print_every, sample_precision, sample_mvr, sample_gp)
}
