...
spiox_latent_vi <- function(Y, X, coords, custom_dag, dag_opts, theta, Sigma_start, Beta_start, Ddiag_start, matern = 1L, num_threads = 1L, verbose = 0L, report = 50L, tol = 1e-2, max_iter = 500L) {
