...
save(file=glue::glue("simulations/trivariate_matern_toy/spiox.RData"), 
...
if(F){
  ...
  save(file=glue::glue("simulations/trivariate_matern_toy/spiox_latentq.RData"), 
...
if(F){
  ...
  save(file=glue::glue("simulations/trivariate_matern_toy/spiox_latentn.RData"), 
...
if(T){
  ...
  save(file=glue::glue("simulations/trivariate_matern_toy/meshed.RData"), 
...
if(T){
  ...
  save(list=c("fit2", "gpgpm"),file = "simulations/trivariate_matern_toy/gpgpm.RData")
