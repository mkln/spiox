...
for(oo in starts:ends){
  ...
  Clist <- optlist %>% lapply(\(nu) spiox::Correlationc(cx_all, cx_all, c(20,1,nu,1e-5), 1, TRUE) )
  ...
  if(T){
    ...
    save(file=glue::glue("simulations/spiox_m/spiox_gibbs_{oo}.RData"), 
  ...
  if(T){
    ...
    save(file=glue::glue("simulations/spiox_m/spiox_metrop_{oo}.RData"), 
  ...
  if(T){
    ...
    save(file=glue::glue("simulations/spiox_m/spiox_clust_{oo}.RData"), 
  ...
  if(T){
    ...
    save(file=glue::glue("simulations/spiox_m/meshed_{oo}.RData"), 
