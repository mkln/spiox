/*---------------------------------------------------------------------------*/
// code below is R package GIGrvg's rng for the generalized Inverse Gaussian
/*---------------------------------------------------------------------------*/
/* header files */
#include <R.h>
//#include <Rmath.h>
...
void
_rgig_ROU_shift_alt (arma::vec & res, int n, double lambda, double lambda_old, double omega, double alpha)
/*---------------------------------------------------------------------------*/
/* Type 8:                                                                   */
...
arma::vec c_rgigauss_vec(int n, double lambda, double chi, double psi)
{
  double omega, alpha;     /* parameters of standard distribution */
  double abs_lambda;       /* absolute value of lambda */
  arma::vec res = arma::zeros(n);           /* results */
  int i;
