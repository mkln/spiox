...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(inocs(Y, X, coords, radgp_rho, theta_options, spf_k, spf_a_delta, spf_b_delta, spf_a_dl, spf_Lambda_start, spf_Delta_start, mvreg_B_start, mcmc, print_every, sample_precision, sample_mvr, sample_gp));
    return rcpp_result_gen;
END_RCPP
}
// inocs_predict
