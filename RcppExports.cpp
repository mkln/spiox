...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type vi_missing_smp(vi_missing_smpSEXP);
    rcpp_result_gen = Rcpp::wrap(spiox_latent_vi(Y, X, coords, custom_dag, dag_opts, Theta, Sigma_start, Beta_start, W_start, Ddiag_start, matern, num_threads, print_every, tol, max_iter, vi_missing_smp));
    return rcpp_result_gen;
END_RCPP
}
// spiox_predict
